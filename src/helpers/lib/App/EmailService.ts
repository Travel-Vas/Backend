...
const verifyBrevoConnection = async () => {
    try {
        ...
        const account:any = await accountApi.getAccount();
...
export class EmailService {
    ...
    private async sendBrevoEmail(
        ...
        try {
            ...
            const result:any = await apiInstance.sendTransacEmail(sendSmtpEmail);
            console.log('✅ Email sent successfully:', {
    ...
    public async clientSelectedPhotosMail(
        subject: string,
        recipient: string,
        name: string,
    ...
    public async clientDownloadNotificationMail(
        subject: string,
        recipient: string,
        name: string,
        shoot_type: any,
    ...
    public async clientEditedPhotosMail(
        subject: string,
        recipient: string,
        client_name: any,
        shoot_type: any,
    ...
    public async contactUsNotificationMail(
        subject: string,
        recipient: string,
        fullName: any,
        email: any,
    ...
    public async invoiceNotificationMail(
        subject: string,
        recipient: string,
        recipientName: any,
        invoiceNumber: any,
    ...
    public async subscriptionNotificationMail(
        subject: string,
        recipient: string,
        recipientName: any,
        plan_name: any,
    ...
    public async subscriptionCancellationNotificationMail(
        subject: string,
        recipient: string,
        recipientName: any,
        plan_name: any,
    ...
    public async subscriptionExpiredNotificationMail(
        subject: string,
        recipient: string,
        recipientName: any,
        plan_name: any,
    ...
    public async accountActivationMail(
        subject: string,
        recipient: string,
        customer_name: string,
    ...
    public async withdrawalNotificationMail(
        subject: string,
        recipient: string,
        customer_name: string,
        amount: any,
    ...
    public async premiumPlanNotificationMail(
        subject: string,
        recipient: string,
        client_name: string,
        plan_name: any,
