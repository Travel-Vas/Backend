...
class PaymentService {
    ...
    static verifyPayment(reference) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tripDetails = yield booking_model_1.Trip.findById(payment.userId);
                if (payment) {
                    ...
                    if (response.data.status === 'success') {
                        ...
                        yield booking_model_1.Trip.findOneAndUpdate({
    ...
    static processNextInstallment(paymentId, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payment = yield payment_model_1.Payment.findById(paymentId).populate('tripId');
                if (!payment) {
                    throw new App_1.CustomError({
